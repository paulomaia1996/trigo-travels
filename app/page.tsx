...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="numbers"><div className="container"><p className="eyebrow light">por que viajar com a trigo</p><div className="number-grid"><div><strong>1:1</strong><p>atendimento próximo do primeiro oi ao retorno</p></div><div><strong>10<span>+</span></strong><p>países visitados e muita história pra contar</p></div><div className="number-card-story"><span>feito para você</span><strong>Do seu<br />jeito</strong><p>cada roteiro começa pela sua história.</p></div></div></div></section>

      <section className="contact" id="contato"><div className="container contact-grid"><div><p className="eyebrow">vamos conversar</p><h2>Para onde<br />o seu coração<br /><em>quer ir?</em></h2><div className="contact-links"><a href="https://wa.me/5521967260597" target="_blank" rel="noreferrer"><small>WhatsApp</small><span>(21) 96726-0597 ↗</span></a><a href="https://www.instagram.com/trigo.travel/" target="_blank" rel="noreferrer"><small>Instagram</small><span>@trigo.travel ↗</span></a></div></div><form onSubmit={handleSubmit}><label htmlFor="name">Como podemos te chamar?</label><input id="name" name="name" placeholder="Seu nome" required /><label htmlFor="dream">Qual viagem você sonha fazer?</label><input id="dream" name="dream" placeholder="Conte um pouquinho" required /><button className="button button-dark" type="submit">Quero conversar <span>→</span></button>{sent && <p className="form-success" role="status">Obrigada! Em breve entraremos em contato.</p>}</form></div></section>
