    ...
    <main>
      <section className="hero" id="inicio">
        <nav className="nav container" aria-label="Navegação principal">
          <a className="brand" href="#inicio" aria-label="TriGo Travel, início"><span>TriGo</span><small>TRAVEL</small></a>
      ...
      <section className="numbers"><div className="container"><p className="eyebrow light">o jeito TriGo de viajar</p><div className="number-grid"><div><strong>3</strong><p>amigas apaixonadas por descobrir o mundo</p></div><div><strong>1.000<span>+</span></strong><p>possibilidades para a sua próxima história</p></div><div><strong>1:1</strong><p>atendimento próximo do primeiro oi ao retorno</p></div></div></div></section>
